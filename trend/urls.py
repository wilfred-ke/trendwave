...
urlpatterns = [
    ...
    path('remove_profile_picture/', views.remove_profile_picture,
    ...
    path('signIn', auth_views.LoginView.as_view(
        template_name="signIn.html"), name='login'),

]

urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)

handler404 = 'trend.views.custom_404_view'
handler500 = 'trend.views.custom_500_view'
